...
class Config(object):
  ...
  def __init__(self):
    args = arguments( 
        root_path = r'C:/Users/siyuan/Documents/IRIS',
        # json file path
        ...
        output_dir=r"C:/Users/siyuan/Documents/IRIS\output",
        test_output_dir=r"C:/Users/siyuan/Documents/IRIS\val", 
        test_size=0.1,
        val_size=0.1, 
        train=True,
        resume = False
    ...
    if cfg.train:
        ...
        for epoch in range(start_epoch, epoch_size): 
            ...
            for batch in train_dataloader:
                ...
                points,labels = generate_prompts_from_masks(mask_labels,total_points=40)
                ...
                sparse_embeddings, _          = sam.prompt_encoder(
                    ...
                    boxes=None,
                    masks=None#mask_labels.clone().detach().to(torch.float32)
                )
    ...
    if (len(test_dataloader)>0):  
        ...
        with torch.no_grad():
            for batch in test_dataloader:
                ...
                image_embeddings = sam.image_encoder(img)
                points,labels = generate_prompts_from_masks(mask_labels,total_points=100)
                points = points.to(cfg.device)
                labels = labels.to(cfg.device)
